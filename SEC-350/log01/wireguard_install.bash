...
sudo wg genkey | sudo tee /etc/wireguard/srvkey-private | wg pubkey | sudo tee /etc/wireguard/srvkey-public
sudo wg genkey | sudo tee /etc/wireguard/client01-private | wg pubkey | sudo tee /etc/wireguard/client01-public
